...
var PrismSlider = (function(window, undefined) {
  ...
  PrismSlider.prototype.applyEffects_ = function() {
    ...
    if (this.mask.effects.rotate) this.rotate_();
    if (this.mask.effects.translate) this.translate_();
  };
   ...
   * Translate Effect.
   */
  PrismSlider.prototype.translate_ = function() {
    this.context.translate(0, this.mask.effects.translate);
  };
